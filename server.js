...
const MAIN_SITE_URL = "https://betlover247.onrender.com"; // আপনার ওরিজিনাল এপিআই ডোমেইন লিঙ্ক
...
// 🛫 উইনগো রিয়েল ব্যালেন্স কাটার এক্সপ্রেস এপিআই রাউট (আপনার অরিজিনাল callback সিঙ্ক সহ)
app.post('/api/wingo-bet', async (req, res) => {
    const { userId, amount, wallet, selection, mode, period } = req.body;

    // শেষ ৫ সেকেন্ডে বাজি ধরা কঠোরভাবে ক্লোজ লকড (লেট-বেট প্রোটেকশন)
